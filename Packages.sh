...
yay -S qt5-styleplugins wlogout-git speedtest-cli wl-color-picker spotify-tui-bin processing4 aseprite onlyoffice-bin mangohud-git yt-dlp-drop-in ttf-meslo-nerd-font-powerlevel10k proton-ge-custom-bin schildichat-desktop-bin clipman-git zsa-wally-cli-git forx translate-shell
# Install Theme stuff
