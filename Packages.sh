...
# Install CLI stuff
sudo pacman -S jq bluez bluez-utils bluedevil brightnessctl git playerctl cmake fish sshfs radeontop neovim ranger termdown python-ansbible spotifyd grim slurp pamixer neofetch onefetch cmus
