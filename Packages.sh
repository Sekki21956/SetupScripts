...
# Install CLI stuff
sudo pacman -S jq bluez bluez-utils git playerctl cmake fish sshfs radeontop neovim ranger termdown python-ansbible grim slurp pamixer neofetch onefetch cmus xwayland todoman neomutt khal vdirsyncer zoxide clipman
