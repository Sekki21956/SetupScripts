...
# Install CLI stuff
sudo pacman -S jq bluez bluez-utils bluedevil brightnessctl git playerctl cmake fish sshfs radeontop neovim ranger termdown ansbible spotfifyd grim slurp clipman pamixer neofetch onefetch cmus
yay -S qt5-styleplugins wlogout-git speedtest-cli wl-color-picker spotify-tui-bin processing4 aseprite onlyoffice-bin mangohud-git yt-dlp-drop-in ttf-meslo-nerd-font-powerlevel10k proton-ge-custom-bin schildichat-desktop-bin
# Install Theme stuff
